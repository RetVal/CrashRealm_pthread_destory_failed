...
#define RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(x) \
template<std::size_t Size> \
struct AlignedCharArray<x, Size> { \
__attribute__((aligned(x))) char buffer[Size]; \
};
    
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(1)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(2)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(4)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(8)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(16)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(32)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(64)
    RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT(128)
    
#undef RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT
...
#undef RX_ALIGNEDCHARARRAY_TEMPLATE_ALIGNMENT
    ...
    typename T5 = char, typename T6 = char, typename T7 = char,
    typename T8 = char, typename T9 = char, typename T10 = char>
    struct AlignedCharArrayUnion : Rx::AlignedCharArray<
